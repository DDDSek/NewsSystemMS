namespace NewsSystem.Application.ArticleCreation.Articles
{
    ...
    public interface IArticleRepository : IRepository<Article>
    {
        ...
        Task<Article> FindArticleComment(int id, CancellationToken cancellationToken = default);

        Task<Comment> FindComment(int id, CancellationToken cancellationToken = default);
